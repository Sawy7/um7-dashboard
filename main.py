...
class UM7Communication:
    ...
    def change_rates(self):
        ...
        # self.set_register_var_value("creg_com_rates4", "ALL_PROC_RATE", 20)
        self.set_register_var_value("creg_com_rates6", "POSE_RATE", 20)
    ...
    def change_settings(self):
        ...
        self.set_register_var_value("creg_com_settings", "SAT", 1)
        pass
    ...
    def print_config(self):
        print(f"\\n========== CONFIG REGISTERS ===================================")
        print(f"creg_com_settings             : {self.um7.creg_com_settings}")
        print(f"creg_com_rates1               : {self.um7.creg_com_rates1}")
        print(f"creg_com_rates2               : {self.um7.creg_com_rates2}")
        print(f"creg_com_rates3               : {self.um7.creg_com_rates3}")
        print(f"creg_com_rates4               : {self.um7.creg_com_rates4}")
        print(f"creg_com_rates5               : {self.um7.creg_com_rates5}")
        print(f"creg_com_rates6               : {self.um7.creg_com_rates6}")
        print(f"creg_com_rates7               : {self.um7.creg_com_rates7}")
        print(f"creg_misc_settings            : {self.um7.creg_misc_settings}")
        print(f"creg_home_north               : {self.um7.creg_home_north}")
        print(f"creg_home_east                : {self.um7.creg_home_east}")
        print(f"creg_home_up                  : {self.um7.creg_home_up}")
        print(f"creg_gyro_trim_x              : {self.um7.creg_gyro_trim_x}")
        print(f"creg_gyro_trim_y              : {self.um7.creg_gyro_trim_y}")
        print(f"creg_gyro_trim_z              : {self.um7.creg_gyro_trim_z}")
        print(f"creg_mag_cal1_1               : {self.um7.creg_mag_cal1_1}")
        print(f"creg_mag_1_cal1_2             : {self.um7.creg_mag_cal1_2}")
        print(f"creg_mag_cal1_3               : {self.um7.creg_mag_cal1_3}")
        print(f"creg_mag_cal2_1               : {self.um7.creg_mag_cal2_1}")
        print(f"creg_mag_cal2_2               : {self.um7.creg_mag_cal2_2}")
        print(f"creg_mag_cal2_3               : {self.um7.creg_mag_cal2_3}")
        print(f"creg_mag_cal3_1               : {self.um7.creg_mag_cal3_1}")
        print(f"creg_mag_cal3_2               : {self.um7.creg_mag_cal3_2}")
        print(f"creg_mag_cal3_3               : {self.um7.creg_mag_cal3_3}")
        print(f"creg_mag_bias_x               : {self.um7.creg_mag_bias_x}")
        print(f"creg_mag_1_bias_y             : {self.um7.creg_mag_bias_y}")
        print(f"creg_mag_bias_z               : {self.um7.creg_mag_bias_z}")
        print(f"creg_accel_cal1_1             : {self.um7.creg_accel_cal1_1}")
        print(f"creg_accel_cal1_2             : {self.um7.creg_accel_cal1_2}")
        print(f"creg_accel_cal1_3             : {self.um7.creg_accel_cal1_3}")
        print(f"creg_accel_cal2_1             : {self.um7.creg_accel_cal2_1}")
        print(f"creg_accel_cal2_2             : {self.um7.creg_accel_cal2_2}")
        print(f"creg_accel_cal2_3             : {self.um7.creg_accel_cal2_3}")
        print(f"creg_accel_cal3_1             : {self.um7.creg_accel_cal3_1}")
        print(f"creg_accel_cal3_2             : {self.um7.creg_accel_cal3_2}")
        print(f"creg_accel_cal3_3             : {self.um7.creg_accel_cal3_3}")
        print(f"creg_accel_bias_x             : {self.um7.creg_accel_bias_x}")
        print(f"creg_accel_bias_y             : {self.um7.creg_accel_bias_y}")
        print(f"creg_accel_bias_z             : {self.um7.creg_accel_bias_z}")
